...
public class DumpDataPagesCommand extends BaseCommand {

  public DumpDataPagesCommand(Logger console) {
    super(console);
  }
  ...
  public int run() throws IOException {
    ...
    int rowGroupNum = 0;
    File f = new File(source + ".datapages");
    ...
    fos.close();
    console.info("expected file size " + humanReadable(expected_filesize));
